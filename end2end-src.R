...
n=length(k)
for(j in 1:n){
a[i,(2k[j]-1):(2k[j])]=get_NA(a[i,(2k[j]-1):(2k[j])])
}
}
dat21=a
...
b=data[(2i-1):(2i),]
true_value1=dat1[2i-1,which(is.na(data[2i-1,]))]
true_value2=dat1[2i,which(is.na(data[2i,]))]
true_value1_p=dat1[2i-1,f1(which(is.na(data[2i-1,])))]
true_value2_p=dat1[2i,f1(which(is.na(data[2i,])))]
...
est_value1[j]=rbeta(1,alpha1[2i-1],beta1[2i-1])
}
est_value2=rep(0,length(which(is.na(data[2,]==T))) )
for(j in 1:length(est_value2)){
est_value2[j]=rbeta(1,alpha1[2i],beta1[2i])
}
...
k=length(which(is.na(data[2i-1,])))/length(data[2i-1,])
...
b=data[(3i-2):(3i),]
true_value1=dat2[3i-2,which(is.na(data[3i-2,]))]
true_value2=dat2[3i-1,which(is.na(data[3i-1,]))]
true_value3=dat2[3i,which(is.na(data[3i,]))]
true_value1_p=dat2[3i-2,f1(which(is.na(data[3i-2,])))]
true_value2_p=dat2[3i-1,f1(which(is.na(data[3i-1,])))]
true_value3_p=dat2[3i,f1(which(is.na(data[3i,])))]
true_value1=abs(true_value1-true_value1_p)
true_value2=abs(true_value2-true_value2_p)
true_value3=abs(true_value3-true_value3_p)
est_value1=rep(0,length(which(is.na(data[1,]==T))))
for(j in 1:length(est_value1)){
est_value1[j]=rbeta(1,alpha2[3i-2],beta2[3i-2])
}
est_value2=rep(0,length(which(is.na(data[2,]==T))))
for(j in 1:length(est_value2)){
est_value2[j]=rbeta(1,alpha2[3i-1],beta2[3i-1])
}
est_value3=rep(0,length(which(is.na(data[3,]==T))))
for(j in 1:length(est_value3)){
est_value3[j]=rbeta(1,alpha2[3i],beta2[3i])
}
est_value1=abs(est_value1-true_value1_p)
est_value2=abs(est_value2-true_value2_p)
...
k=length(which(is.na(data[3i-2,])))/length(data[3i-2,])
...
b=data[(2i-1):(2i),]
true_value1=data1[2i-1,which(is.na(data[2i-1,]))]
true_value2=data1[2i,which(is.na(data[2i,]))]
est_value1=abs(rnorm(length(true_value1),mean=a1$mean[2i-1],sd=a1$sd[2i-1]))
est_value2=abs(rnorm(length(true_value2),mean=a1$mean[2i],sd=a1$sd[2i]))
REM=sum(abs(true_value1 - est_value1))+ sum(abs(true_value2 - est_value2))
k=mean(length(which(is.na(data[2i-1,])))/length(data[2i-1,]),length(which(is.na(data[2i,])))/length(data[2i,]))
...
b=data[(3i-2):(3i),]
true_value1=data2[3i-2,which(is.na(data[3i-2,]))]
true_value2=data2[3i-1,which(is.na(data[3i-1,]))]
true_value3=data2[3i,which(is.na(data[3i,]))]
est_value1=abs(rnorm(length(true_value1),mean=a2$mean[3i-2],sd=a2$sd[3i-2]))
est_value2=abs(rnorm(length(true_value2),mean=a2$mean[3i-1],sd=a2$sd[3i-1]))
est_value3=abs(rnorm(length(true_value3),mean=a2$mean[3i],sd=a2$sd[3i]))
REM=sum(abs(true_value1 - est_value1))+sum(abs(true_value2 - est_value2))+sum(abs(true_value3 - est_value3))
k=mean(length(which(is.na(data[3i-2,])))/length(data[3i-2,]),length(which(is.na(data[3i-1,])))/length(data[3i-1,]),length(which(is.na(data[3i,])))/length(data[3i,]))
...
b=data[(2i-1):(2i),]
true_value12=data1[(2i-1):(2i),which(is.na(data[2i-1,]))]
true_value12_order=true_value12[,order(true_value12[2,])]
true_value1=true_value12_order[1,]
true_value21=data1[(2i-1):(2i),which(is.na(data[2i,]))]
...
b=data[(3i-2):(3i),]
true_value12=data2[(3i-2):(3i),which(is.na(data[3i-2,]))]
true_value12_order=true_value12[,order(true_value12[2,]+true_value12[3,])]
true_value1=true_value12_order[1,]
true_value21=data2[(3i-2):(3i),which(is.na(data[3i-1,]))]
true_value21_order=true_value21[,order(true_value21[1,]+true_value21[3,])]
true_value2=true_value21_order[2,]
true_value13=data2[(3i-2):(3i),which(is.na(data[3i,]))]
...
REM=sum(abs(true_value1 - est_value1))+sum(abs(true_value2 - est_value2))+sum(abs(true_value3 - est_value3))
k=mean(length(which(is.na(data[3i-2,])))/length(data[3i-2,]),length(which(is.na(data[3i-1,])))/length(data[3i-1,]),length(which(is.na(data[3i,])))/length(data[3*i,]))
