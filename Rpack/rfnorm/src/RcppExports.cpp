...
// rcpp_symbolic_matrix
arma::mat rcpp_symbolic_matrix(int n);
RcppExport SEXP _rfnorm_rcpp_symbolic_matrix(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_symbolic_matrix(n));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_mixing_sample
double rcpp_mixing_sample(int N, int d, int pos, NumericVector x, arma::mat Sigma);
RcppExport SEXP _rfnorm_rcpp_mixing_sample(SEXP NSEXP, SEXP dSEXP, SEXP posSEXP, SEXP xSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_mixing_sample(N, d, pos, x, Sigma));
    return rcpp_result_gen;
END_RCPP
}
